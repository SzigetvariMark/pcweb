...
export default function Featured({ featuedProduct }) {
  ...
  return (
    <div className="p-4 text-black font-semibold w-full max-md:shadow-md max-md:border-2 max-md:rounded-lg max-md:m-4">
      <div className="grid grid-cols-2 max-md:grid-cols-1 gap-10">
        <div className="flex flex-col justify-right">
          ...
          <div className="mt-6">
            <div className="max-md:flex max-md:justify-center flex items-center">
